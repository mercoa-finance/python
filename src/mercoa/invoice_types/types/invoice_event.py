...
class InvoiceEvent(UniversalBaseModel):
    ...
    webhook_ids: typing_extensions.Annotated[typing.List[str], FieldMetadata(alias="webhookIds")]
    data: InvoiceUpdateRequest
    ...
    ip_address: typing_extensions.Annotated[typing.Optional[str], FieldMetadata(alias="ipAddress")] = None
