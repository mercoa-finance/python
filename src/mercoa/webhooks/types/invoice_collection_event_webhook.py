...
import typing
from ...collection_types.types.email_message_response import EmailMessageResponse
from ...core.pydantic_utilities import IS_PYDANTIC_V2


class InvoiceCollectionEventWebhook(UniversalBaseModel):
    """
    Examples
    --------
    import datetime
    ...
    from mercoa.webhooks import InvoiceCollectionEventWebhook

    InvoiceCollectionEventWebhook(
        event_type="invoice.collection.overdue",
    ...
    email: typing.Optional[EmailMessageResponse] = pydantic.Field(default=None)
    """
