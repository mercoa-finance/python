...
class GenerateContractAsyncJobResponse(UniversalBaseModel):
    """
    Examples
    --------
    import datetime
    ...
    status: ContractJobStatus = pydantic.Field()
    """
    Job status
    """

    contract: typing.Optional[ContractResponse] = pydantic.Field(default=None)
    """
    Contract
    """
